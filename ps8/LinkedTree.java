...
public class LinkedTree {
    ...
    public LinkedTreeIterator inorderIterator(){
        LinkedTreeIterator iter = new InorderIterator();
        return iter;
    }
    ...
    public void insert(int key, Object data) {
        ...
        if (parent == null) {    // the tree was empty
            ...
            //System.out.println(key+"parents:"+parent.key);
            parent.left = newNode;
        } else {
            //System.out.println(key+"parents:"+parent.key);
    ...
    public LLList delete(int key) {
        ...
        if (trav == null) {   // no such key    
            ...
            //System.out.println("old parent:"+parent.key);
            deleteNode(trav, parent);
            //System.out.println("new parent:"+parent.key);
            return removedData;
        }
    }
    ...
    public static int height(Node root){
        if(root == null){
            ...
            int len1 = height(root.left);
            int len2 = height(root.right);
            if(len1>len2){
                return len1+1;
            }else{
                return len2+1;
    ...
    public static void main(String[] args) {
        LinkedTree x = new LinkedTree();
        int[] a = {44,35,53,23,28,48,62,57,80};
        x.insertKeys(a);
        x.levelOrderPrint();
        System.out.println();
        System.out.println(height(x.root));
        Node n = x.mirror(x.root);
        x.levelOrderPrint();
        System.out.println();
        
        /** Add your test code here **/
        LinkedTree x1 = new LinkedTree();
        int[] arr = {44,35,53,23,28,48,62,57,80};
        x1.insertKeys(arr);
        x1.levelOrderPrint();
        System.out.println();
        int[] y1 ={23,28,35,44,48,53,57,62,80};
        for(int i=0;i<y1.length;i++){
            System.out.print(y1[i]+" ");
        }
        System.out.println();
        LinkedTreeIterator test1 = x1.inorderIterator();
        while(test1.hasNext()){
        ...
        //test2
        System.out.println();
        LinkedTree x2 = new LinkedTree();
        int[] arr2 = {44,35,23,40,15,3};
        x2.insertKeys(arr2);
        x2.levelOrderPrint();
        System.out.println();
        int[] y2 ={3,15,23,35,40,44};
        for(int i=0;i<y2.length;i++){
            System.out.print(y2[i]+" ");
        }
        LinkedTreeIterator test2 = x2.inorderIterator();
        System.out.println();
        while(test2.hasNext()){
        ...
        LinkedTreeIterator test3 = x3.inorderIterator();
        System.out.println();
        while(test3.hasNext()){
